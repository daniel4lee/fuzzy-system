...
class GuiRoot(QWidget):
    ...
    def semantic_rule_setting_creation(self):
        ...
        self.values[6].setValue(-10)
        self.values[8].setValue(0)
        self.values[10].setValue(10)
        ...
        self.values[15].setValue(20)
        self.values[16].setValue(10)
        self.values[17].setValue(20)
